export const BranchesTableConfig = {
	...
	actions: [
		{ label: 'View', icon: 'Eye', route: 'BranchController.show(branch.branch_slug)', className: 'bg-transparent hover:bg-transparent text-gray-600 hover:text-gray-900 cursor-pointer' },
