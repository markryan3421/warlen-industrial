...
class AttendanceSchedule extends Model
{
    ...
    public function scopeHolidays($q)
    {
        return $q->where('shift_label', 'Holiday');
    }
    public function scopeLeaves($q)
    {
        return $q->where('shift_code', '25');
    }

    #[Scope]
    protected function getAttendanceShed(Builder $query): void
    {
        $query->select([
            'employee_id',
            'employee_name',
